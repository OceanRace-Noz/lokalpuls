...
const TimeFilter: React.FC<TimeFilterProps> = ({
  ...
  return <div className="bg-[rgba(50,50,50,1)] flex w-full items-center gap-[3px] text-sm text-[rgba(83,83,83,1)] font-normal leading-none justify-between mt-[19px] my-0">
