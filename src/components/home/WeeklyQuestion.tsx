  ...
  return (
    <div className="w-full pt-[15px] rounded-[0px_0px_0px_0px]">
      <div className="bg-[rgba(78,172,229,1)] flex flex-col items-stretch justify-center px-[5px] py-[3px] rounded-[5px]">
        <div className="bg-[rgba(224,235,242,1)] z-10 flex mt-[-5px] w-full flex-col items-stretch pt-4 pb-2.5 px-4 rounded-[5px]">
          ...
          <div className="flex w-full items-center gap-[40px_100px] justify-between mt-5">
            <div className="text-[rgba(133,133,133,1)] text-xs font-bold leading-none underline self-stretch my-auto cursor-pointer">
              32 Antworten
            </div>
