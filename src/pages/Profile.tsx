...
const Profile: React.FC = () => {
  ...
  return (
    <main className="bg-[rgba(242,242,242,1)] flex w-full flex-col items-stretch mx-auto pb-[75px] font-dongle">
      {/* Header */}
      <div className="bg-[#2C2C2C] w-full text-white p-4">
        <div className="container mx-auto max-w-4xl px-4">
          <div className="flex items-center">
            ...
            <h1 className="font-league-spartan text-xl font-semibold mx-auto pr-[72px]">
              Profil
            </h1>
          </div>
        </div>
